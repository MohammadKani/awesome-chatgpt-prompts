...
<h3 align="center">حامیان پروژه</h3>
...
<div align="center">
  ...
  <br>
  <sub>با Clemta، شرکت خود را از خانه مدیریت کنید.</sub>
<hr>
   <a href="https://www.warp.dev/awesome-chatgpt-prompts">
      <img alt="Warp sponsorship" width="400" src="https://github.com/user-attachments/assets/ab8dd143-b0fd-4904-bdc5-dd7ecac94eae">
   </a>

#### [Warp، ترمینال هوشمند برای توسعه‌دهندگان](https://www.warp.dev/awesome-chatgpt-prompts)
[در دسترس برای مک، لینوکس و ویندوز](https://www.warp.dev/awesome-chatgpt-prompts)<br>
...
<hr>
  ...
  <br>
  <sub>Graphite، پلتفرم بهره‌وری توسعه‌دهندگان با هوش مصنوعی برای تیم‌های گیت‌هاب.</sub>
<hr>
  ...
  <br>
  <sub>اگر MCP می‌سازید، <a href="https://github.com/f/mcptools">MCP Tools</a> یک ابزار همه‌کاره برای سرورهای MCP است.</sub>
<hr>
  <sub><a href="https://github.com/sponsors/f/sponsorships?sponsor=f&amp;tier_id=319423">حامی من شوید تا لوگوی شما اینجا قرار گیرد!</a></sub>
</div>
</div>
...
به مخزن «پرامپت‌های عالی ChatGPT» خوش آمدید! این مجموعه ابتدا برای [ChatGPT](https://chat.openai.com/chat) ساخته شد اما این پرامپت‌ها برای مدل‌های هوش مصنوعی دیگر مانند [Claude](https://claude.ai/new)، [Gemini](https://gemini.google.com)، [Hugging Face Chat](https://hf.co/chat)، [Llama](https://meta.ai)، [Mistral](https://chat.mistral.ai) و غیره نیز مناسب هستند.

[ChatGPT](https://chat.openai.com/chat) یک رابط وب از [OpenAI](https://openai.com) است که به مدل‌های زبانی GPT (ترنسفورمر پیش‌آموزش دیده) دسترسی می‌دهد. مدل‌های پایه مانند GPT-4o و GPT-o1، مدل‌های زبانی بزرگی هستند که با حجم عظیمی از داده‌های متنی آموزش دیده‌اند و می‌توانند متن‌هایی شبیه انسان تولید و درک کنند. مانند سایر رابط‌های چت هوش مصنوعی، شما می‌توانید پرامپت‌ها را وارد کنید و مکالمه طبیعی با هوش مصنوعی داشته باشید تا پاسخ‌های متنی متناسب با تاریخچه گفتگو و ورودی شما تولید کند.

در این مخزن، انواع پرامپت‌هایی را خواهید یافت که می‌توانید با ChatGPT و سایر مدل‌های چت هوش مصنوعی استفاده کنید. شما را تشویق می‌کنیم [پرامپت‌های خود را اضافه کنید](https://github.com/f/awesome-chatgpt-prompts/edit/main/README.md) و همچنین با کمک هوش مصنوعی پرامپت‌های جدید بسازید.

برای شروع، کافیست این مخزن را کلون کنید و از پرامپت‌های موجود در فایل README.md به عنوان ورودی مدل هوش مصنوعی مورد علاقه خود استفاده کنید. همچنین می‌توانید از این پرامپت‌ها برای الهام گرفتن و ساخت پرامپت‌های شخصی خود بهره ببرید.

امیدواریم این پرامپت‌ها برای شما مفید باشند و از کشف مدل‌های چت هوش مصنوعی لذت ببرید!

**[مشاهده در prompts.ir](https://prompts.ir)**

**[مشاهده در Hugging Face](https://huggingface.co/datasets/fka/awesome-chatgpt-prompts/)**
---

> ℹ️ **توجه:** گاهی برخی پرامپت‌ها ممکن است مطابق انتظار شما عمل نکنند یا توسط هوش مصنوعی رد شوند. لطفاً دوباره تلاش کنید، یک گفتگوی جدید شروع کنید یا از حساب کاربری خود خارج و دوباره وارد شوید. اگر این راه‌حل‌ها مؤثر نبودند، سعی کنید پرامپت را با جملات خودتان و با حفظ دستورالعمل‌ها بازنویسی کنید.

### چگونه پرامپت مؤثر بنویسیم؟

کتاب الکترونیکی‌ای با عنوان **«هنر پرامپت‌نویسی ChatGPT: راهنمای ساخت پرامپت‌های واضح و مؤثر»** نوشته‌ام.

📖 **[مطالعه کتاب](https://fka.gumroad.com/l/art-of-chatgpt-prompting)**

### چگونه با پرامپت‌های ChatGPT کسب درآمد کنیم؟

کتاب الکترونیکی‌ای با عنوان **«چگونه با ChatGPT پول دربیاوریم: استراتژی‌ها، نکات و تاکتیک‌ها»** نوشته‌ام.

📖 **[خرید کتاب](https://fka.gumroad.com/l/how-to-make-money-with-chatgpt)**

### چگونه پرامپت تصویر برای Midjourney AI بنویسیم؟

کتاب الکترونیکی‌ای با عنوان **«هنر Midjourney AI: راهنمای ساخت تصویر از متن»** نوشته‌ام.

📖 **[مطالعه کتاب](https://fka.gumroad.com/l/the-art-of-midjourney-ai-guide-to-creating-images-from-text)**

---

### استفاده از prompts.ir

[prompts.ir](https://prompts.ir) برای تجربه کاربری بهتر هنگام کار با پرامپت‌ها طراحی شده است. تنها با چند کلیک می‌توانید پرامپت‌ها را به راحتی ویرایش و کپی کنید تا متناسب با نیاز و سلیقه خودتان شوند.
...
## پرامپت‌های ادغام نشده

در این مخزن درخواست‌های Pull زیادی منتظر ادغام هستند و پرامپت‌های ارزشمند زیادی در آن‌ها پنهان شده‌اند. حتماً نگاهی بیندازید!

📖 **[مشاهده پرامپت‌های ادغام نشده](https://github.com/f/awesome-chatgpt-prompts/pulls)**

---

# پرامپت‌ها

## نقش یک توسعه‌دهنده اتریوم را بازی کن

... ادامه ترجمه و راست‌چین‌سازی سایر پرامپت‌ها ...
